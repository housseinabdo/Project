...
public class FixedTimeFuzzyODE implements FirstOrderDifferentialEquations, EventHandler {
	...
	public FixedTimeFuzzyODE(double tbreak, double tmax, double K, double FC) {
	...
	public void computeDerivatives(double t, double[] y, double[] yDot) {
		...
		double M = y[0], MC = y[1], TR = y[2], X = y[3], Open = y[4], out = y[5], F_deluge = 1800, A = 1,
